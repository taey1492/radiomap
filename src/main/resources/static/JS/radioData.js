...
const radioAction = () => {
    for (let i = 0; i < radioMarkerArray.length; i++) {
        ...
        let markerImage = new kakao.maps.MarkerImage(radioMarkerArray[i].marker_radio, imageSize, imageOption);

        // 마커를 생성
        // 지도를 표시할 div와  지도 옵션으로  지도를 생성합니다
        let markerPosition = new kakao.maps.LatLng(radioMarkerArray[i].radioLat, radioMarkerArray[i].radioLon);
